...
## OpenFOAM
[Download: V7](https://openfoam.org/download/7-source/)

Please download V7 from the above link and install it using [Singularity](https://singularity.lbl.gov/) on the Cluster. 
...
- For an updated list of publications, please download my CV.
