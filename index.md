...
## Poem on the Navier-Stokes Equations

The Navier-Stokes equations, so complex and grand,

Describe the flow of fluid, like water and sand.


From viscosity to pressure, they take into account,

The forces that govern, with every flow devout.


With continuity and momentum, they balance right,

To predict the velocity, at day and at night.


From laminar to turbulent, they adapt with ease,

Guiding the flow, with effortless breeze.


In pipes and in channels, on land and at sea,

The Navier-Stokes equations, forever will be.


A cornerstone of fluid dynamics, a treasure to seek,

The Navier-Stokes equations, forever unique.
<!-- Accepted papers:

[Effect of geometric parameters on the noise generated by rod-airfoil configuration](https://doi.org/10.1016/j.apacoust.2021.107908)


[On a lower-order framework for jet noise prediction based on one-dimensional turbulence](https://arxiv.org/abs/2010.11050) -->
